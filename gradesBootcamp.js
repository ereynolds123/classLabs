...
function totalReadabilityScore() {
  let readabilityScore = [4,4,3,3, 3,3, 3]; //Add your readability scores here
  let totalScore = 0;
...
function totalOrganizationScore() {
    let organizationScore = [3,3, 3, 3, 4,3,3]; //Add your organization scores here
...
function totalFunctionalityScore() {
    let functionalityScore = [3,3,3,3,3,3,3]; //Add your functionality scores her
